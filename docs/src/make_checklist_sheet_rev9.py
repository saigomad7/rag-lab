import html
import re
OUT='rag_checklist_sheet_rev9.html'
...
<div class="title"><b>RAG_단계별_체크리스트_간소화</b><span>rev.9 · 2026-09-22 · 소스 7종 (엔지니어 · 지식문서 제외) · 정적 문서</span></div>
...
<div class="foot">관련 문서: 단계별 체크리스트 rev3 · 설계 가이드 rev4 · 퀘스트 보드 rev4 · 스모크 20문항 (본 시트 = 간소화 병행본)<br>MIS RAG-SHEET-001 rev.9 · 2026-09-19 · 반도체 MIS DT</div>
</div></body></html>'''
